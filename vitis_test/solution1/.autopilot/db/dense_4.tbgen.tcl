...
set hasInterrupt 0
set C_modelName {dense_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 16 regular {array 944 { 1 3 } 1 1 }  }
	{ output_r int 15 regular {array 16 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_biases_4_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dense_weights_4_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_7s_24s_24_4_1_U32", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15109", "Max" : "15109"}
	, {"Name" : "Interval", "Min" : "15109", "Max" : "15109"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 4 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 15 } } }
}
