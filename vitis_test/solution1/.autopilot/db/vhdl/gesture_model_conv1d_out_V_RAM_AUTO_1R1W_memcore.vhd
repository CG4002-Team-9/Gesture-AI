...
entity gesture_model_conv1d_out_V_RAM_AUTO_1R1W_memcore is 
    generic(
        MEM_TYPE        : string    := "auto"; 
        DataWidth       : integer   := 15; 
        AddressWidth    : integer   := 8;
        AddressRange    : integer   := 210
    ); 
    port (
...
architecture rtl of gesture_model_conv1d_out_V_RAM_AUTO_1R1W_memcore is 
