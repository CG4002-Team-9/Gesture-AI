...
typedef struct {
    ...
    XGesture_model_uio_map maps[ MAX_UIO_MAPS ];
} XGesture_model_uio_info;

/***************** Variable Definitions **************************************/
static XGesture_model_uio_info uio_info;
...
static int uio_info_read_name(XGesture_model_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XGesture_model_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XGesture_model_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XGesture_model_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XGesture_model_Initialize(XGesture_model *InstancePtr, const char* InstanceName) {
	XGesture_model_uio_info *InfoPtr = &uio_info;
