...
`timescale 1ns/1ps
module gesture_model_batch_norm_out_0_V_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 24,
    AddressRange = 1888,
    AddressWidth = 11,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        gesture_model_batch_norm_out_0_V_RAM_AUTO_1R1W_memcore gesture_model_batch_norm_out_0_V_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
