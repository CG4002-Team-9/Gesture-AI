...
void myproject_float(
    ...
    result_t layer18_out_ap[N_LAYER_17];

    myproject(input_1_ap,layer18_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_17>(layer18_out_ap, layer18_out);
}

void myproject_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1],
    double layer18_out[N_LAYER_17]
) {
    // hls-fpga-machine-learning insert namespace
    ...
    nnet::convert_data<result_t, double, N_LAYER_17>(layer18_out_ap, layer18_out);
}
}
